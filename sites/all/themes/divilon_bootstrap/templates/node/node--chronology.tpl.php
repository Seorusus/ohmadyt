<?php 
  $gallery = false;
  if(count ($node->field_gallery)) {
    $gallery = node_load($node->field_gallery["und"][0]["target_id"]);
...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php if($gallery): ?>
    <div class="field-name-field-image">
      <img src="<?php print file_create_url($gallery->field_photos['und'][0]['uri']); ?>" class="img-responsive" title="<?php print $title; ?>" />
    </div>
  <?php endif; ?>
  <?php
